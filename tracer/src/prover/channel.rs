...
use crate::air::proof::{Commitments, OodFrame, StarkProof};
use core::marker::PhantomData;
use winter_air::{
    proof::{Context, Queries},
    ...
    R: RandomCoin<BaseField = A::BaseField, Hasher = H>,
{
    ...
    pub fn build_proof(
        self,
        trace_queries: Vec<Vec<Queries>>,
        constraint_queries: Vec<Queries>,
        fri_proof: FriProof,
    ) -> StarkProof {
        StarkProof {
...
impl<'a, A, E, H, R> winter_fri::ProverChannel<E> for ProverChannel<'a, A, E, H, R>
where
    A: Air,
    E: FieldElement<BaseField = A::BaseField>,
    H: ElementHasher<BaseField = A::BaseField>,
